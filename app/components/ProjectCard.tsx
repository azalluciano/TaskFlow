...
const ProjectCard: FC<ProjectProps> = ({ project, admin, style, onDelete }) => {
  ...
  const progressPecentage = totalTasks
  ...
  return (
    ...
    >
      <div className="w-full flex items-center mb-3">
        <div className="bg-primary-content text-xl h-10 w-10 rounded-lg flex justify-center">
          <FolderGit2 className="w-6 text-primary" />
        </div>
        <div className="badge m-3 font-bold">{project.name}</div>
      </div>
      {style == false && (
      ...
      <div className={`mb-3 `}>
        ...
        <div className="badge badge-sm ml-1 badge-ghost">
